...
Extensions are installed in a per-user extensions folder.

**Can I download an extension directly from the Marketplace?**

Yes, use the Download Extension link on the extension's Marketplace page.

**Can I stop VS Code from providing extension recommendations?**

Adjust settings like extensions.showRecommendationsOnlyOnDemand and extensions.ignoreRecommendations.

**Can I trust extensions from the Marketplace?**

The Marketplace runs a virus scan, provides ratings, Q&A, and other resources for informed decisions. Report suspicious extensions.